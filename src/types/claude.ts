/**
 * Domain types for the Claude Agent Console.
 * These are the app's internal types — not the raw SDK types.
 */
...
// ── Events ───────────────────────────────────────────────────
// Thin wrappers around SDKMessage for the renderer. Only fields
// that the UI actually needs are included to keep payloads small.
